 ...
 */
class Market extends \App\Entities\Market implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Market' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Market' . "\0" . 'name', '' . "\0" . 'App\\Entities\\Market' . "\0" . 'remoteId', '' . "\0" . 'App\\Entities\\Market' . "\0" . 'iconLink', '' . "\0" . 'App\\Entities\\Market' . "\0" . 'color'];
        }
    ...
    public function getIconLink(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIconLink', []);

        return parent::getIconLink();
    }
    ...
    public function setIconLink(string $iconLink): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIconLink', [$iconLink]);

        parent::setIconLink($iconLink);
    }
