...
class Customer extends \App\Entities\Customer implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Customer' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Customer' . "\0" . 'name', '' . "\0" . 'App\\Entities\\Customer' . "\0" . 'remoteId', '' . "\0" . 'App\\Entities\\Customer' . "\0" . 'createdAt'];
        }
