 ...
 */
class OrderStatus extends \App\Entities\OrderStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\OrderStatus' . "\0" . 'id', '' . "\0" . 'App\\Entities\\OrderStatus' . "\0" . 'name', '' . "\0" . 'App\\Entities\\OrderStatus' . "\0" . 'remoteId', '' . "\0" . 'App\\Entities\\OrderStatus' . "\0" . 'color'];
        }
