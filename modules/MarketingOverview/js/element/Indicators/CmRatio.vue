<template>
    <div class="mo-indicators">
        ...
        <div class="mo-indicator-value">
            <span :class="setColor">{{ cmRatio }}%</span>
            <span>Cm Ratio</span>
        </div>
        <div class="mo-indicator-value secondary">
            <span>{{ cmRatioLastHour }}% <span class="percent"><span v-if="cmRatioLast30Minutes > 0">+</span>{{ cmRatioLast30Minutes }}</span></span>
            <span>last hour</span>
        </div>
    </div>
</template>
...
export default {
    ...
    methods:{
        update(){
            this.cmRatio = this.chartData.totals.cm_ratio.value.toFixed(0);
            this.cmRatioLastHour = this.chartData.totals.cm_ratio.last_hour.toFixed(0);
            this.cmRatioLast30Minutes = this.chartData.totals.cm_ratio.last_30_minutes.toFixed(0);
        },
