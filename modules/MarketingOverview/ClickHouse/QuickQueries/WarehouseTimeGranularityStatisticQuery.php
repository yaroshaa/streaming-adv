...
/**
 * Class WarehouseTimeGranularityStatisticQuery
 * @package Modules\MarketingOverview\ClickHouse\QuickQueries
 */
class WarehouseTimeGranularityStatisticQuery extends BaseQuickQuery
{
    private Carbon $from;
    private Carbon $to;
    ...
    function __toString(): string
    {
        ...
        return <<<SQL
            ...
            {$where}
            GROUP BY warehouse_id, {$timeAlias} 
            ORDER BY warehouse_id, {$timeAlias}
        SQL;
    }
}
