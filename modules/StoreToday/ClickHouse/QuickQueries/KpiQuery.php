...
class KpiQuery extends BaseQuickQuery
{
    private Carbon $from;
    private Carbon $to;
    ...
    public function __construct(Carbon $from, Carbon $to, array $marketIds, int $currencyId, string $granularity)
    {
        $this->from = $from;
        $this->to = $to;
    ...
    public function __toString(): string
    {
        ...
        return <<<SQL
            ...
            SELECT {$granularity}                                   as date,
                   ...
                   round(product_discount / total_profit, 2)                                               as product_discount_percent
            FROM (
