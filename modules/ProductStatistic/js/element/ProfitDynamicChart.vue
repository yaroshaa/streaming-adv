<template>
    <div id="profit-dynamic-container">
        <h3 class="mt-2 text-left pl-5">Profit</h3>
        <div
            id="profit-dynamic-chart"
            class="profit-chart-chart m-3"
            @data:updated="update"
            ref="profit-dynamic"
        ></div>
    </div>
...
export default {
    ...
    mounted() {
        ...
        const container = document.getElementById('profit-dynamic-chart');
        this.width = container.clientWidth - this.margin.left - this.margin.right;
        this.height = 200 - this.margin.top - this.margin.bottom;

        this.svg = d3
            .select('#profit-dynamic-chart')
            .append('svg')
            .attr('width', '100%')
        ...
        renderChart() {
            ...
            barGroups
                ...
                .on('mouseover', function (d, i) {
                    Tooltip
                        .html(
                            `<div>Date: ${i.date}</div><div>Profit: ${i.value}</div>`
                        )
    ...
    computed: {
        ...
        chartData() {
            return this.dataList.profit_dynamic;
        },
